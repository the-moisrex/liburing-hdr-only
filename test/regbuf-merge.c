...
int main(int argc, char* argv[]) {
    ...
    mmap((void*) 0x1ffff000ul, 0x1000ul, PROT_NONE, MAP_PRIVATE | MAP_FIXED | MAP_ANONYMOUS, -1, 0ul);
    mmap((void*) 0x20000000ul,
         ...
         -1,
         0ul);
    mmap((void*) 0x21000000ul, 0x1000ul, PROT_NONE, MAP_PRIVATE | MAP_FIXED | MAP_ANONYMOUS, -1, 0ul);
