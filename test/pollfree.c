    ...
    switch (call) {
        ...
        case 1:
            ...
            *(uint32_t*) 0x20000a98 = -1;
            ...
            res = -1;
            res = syz_io_uring_setup(0x87, 0x20000a80, 0x206d6000, 0x206d7000, 0x20000000, 0x20000040);
            if (res != -1) {
                r[1] = res;
        ...
        case 2:
            ...
            *(uint16_t*) 0x2000226a = 0;
            ...
            break;
        case 3: syscall(__NR_io_uring_enter, r[1], 0x1523a, 0, 0ul, 0ul, 0xaul); break;
    }
}
