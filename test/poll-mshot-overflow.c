...
static int test(bool defer_taskrun) {
    ...
    struct io_uring_params params = {/* cheat using SINGLE_ISSUER existence to know if this behaviour
                                      * is updated
                                      */
...
static int test_downgrade(bool support_defer) {
    ...
    struct io_uring_params params = {.flags = IORING_SETUP_CQSIZE, .cq_entries = 2};
