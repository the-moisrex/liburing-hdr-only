...
static int
__test_io(const char* file, struct io_uring* ring, int tc, int read, int sqthread, int fixed, int nonvec) {
...
static int test_io(const char* file, int tc, int read, int sqthread, int fixed, int nonvec) {
