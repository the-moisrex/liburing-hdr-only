    ...
    for (i = 0; i < 2; i++) {
        ...
        switch (cqe->user_data) {
            case 1:
                ...
                break;
            case 2:
                if (cqe->res != -EALREADY && cqe->res != -ETIME && cqe->res != 0) {
