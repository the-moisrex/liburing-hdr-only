...
static int submit_write(struct io_uring* ring, int fd, const char* str, int wait) {
...
int main(int argc, char* argv[]) {
    ...
    shmem = mmap(0, sizeof(struct forktestmem), PROT_READ | PROT_WRITE, MAP_SHARED | MAP_ANONYMOUS, 0, 0);
    if (!shmem) {
